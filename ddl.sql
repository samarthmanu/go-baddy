...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--duplicate games query

select g1.game_id, g2.game_id
FROM games_v2 g1,
     games_v2 g2
WHERE g1.game_id != g2.game_id
AND   ((g1.t1 = g2.t1 AND g1.t2 = g1.t2) OR (g1.t1 = g2.t2 AND g1.t2 = g2.t1))
AND   ((g1.score1 = g2.score1 AND g1.score2 = g2.score2) OR (g1.score1 = g2.score2 AND g1.score2 = g2.score1))
AND   g1.played_on = g2.played_on
AND   (g1.invalidate = FALSE AND g2.invalidate = FALSE)
